...
def bdev_nvme_set_options(client, action_on_timeout=None, timeout_us=None, timeout_admin_us=None,
                          ...
                          chap_digests=None, chap_dhgroups=None):
    ...
    Args:
        ...
        chap_digests: List of allowed DH-HMAC-CHAP digests.
        chap_dhgroups: List of allowed DH-HMAC-CHAP DH groups.
    ...
    if chap_digests is not None:
        params['chap_digests'] = chap_digests

    if chap_dhgroups is not None:
        params['chap_dhgroups'] = chap_dhgroups
...
def bdev_nvme_attach_controller(client, name, trtype, traddr, adrfam=None, trsvcid=None,
                                ...
                                chap_key=None, chap_ctrlr_key=None):
    ...
    Args:
        ...
        chap_key: DH-HMAC-CHAP key.
        chap_ctrlr_key: DH-HMAC-CHAP controller key.
    ...
    if chap_key is not None:
        params['chap_key'] = chap_key

    if chap_ctrlr_key is not None:
        params['chap_ctrlr_key'] = chap_ctrlr_key
