...
removed in the v24.05 release.  Instead, a key obtained from the keyring library should be passed
...
deprecated and will be removed in the v24.05 release.  Instead, the name of a key attached to the
