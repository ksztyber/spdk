...
spdk_accel_initialize(void)
{
	...
	/* The module list is order by priority, with the highest priority modules being at the head
	 * of the list.  The software module should be somewhere at the end of the list, behind all
	 * HW modules.
	 *
