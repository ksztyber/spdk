...
struct spdk_key *nvmf_subsystem_get_chap_key(struct spdk_nvmf_subsystem *subsystem, const char *hostnqn);
...
void nvmf_auth_request_exec(struct spdk_nvmf_request *req);
