...
chap_digests               | Optional | list        | List of allowed DH-HMAC-CHAP digests.
chap_dhgroups              | Optional | list        | List of allowed DH-HMAC-CHAP DH groups.
...
chap_ctrlr_key             | Optional | string      | DH-HMAC-CHAP controller key.
