 ...
 *
 * \param id Digest identifier (see `enum spdk_nvmf_auth_hash`).
 *
 * \return Name of the digest.
 */
const char *spdk_nvme_auth_get_digest_name(int id);
 ...
 *
 * \return Digest id (see `enum spdk_nvmf_auth_hash`) or negative errno on failure.
 */
int spdk_nvme_auth_get_digest_id(const char *name);
 ...
 */
uint8_t spdk_nvme_auth_get_digest_length(int id);

/**
 * Return the name of a Diffie-Hellman group.
 *
 * \param id Diffie-Hellman group identifier (see `enum spdk_nvmf_auth_dhgroup`).
 *
 * \return Name of the Diffie-Hellman group.
 */
const char *spdk_nvme_auth_get_dhgroup_name(int id);
 ...
 *
 * \return Diffie-Hellman group id (see `enum spdk_nvmf_auth_dhgroup`) or negative errno on failure.
 */
