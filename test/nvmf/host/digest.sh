...
# transport error status and the host should retry the requests until successful.  Test both small
# writes fitting within a CapsuleCmd as well as large ones requiring H2CData PDUs.
